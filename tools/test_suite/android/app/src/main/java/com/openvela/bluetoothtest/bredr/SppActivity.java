...
import com.openvela.bluetooth.BluetoothSpp;
...
public class SppActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Init BluetoothSpp
        btSpp_1 = new BluetoothSpp(1, mHandler);
        btSpp_2 = new BluetoothSpp(2, mHandler);
    }
    ...
    // Handle Message from BluetoothSpp
    private final Handler mHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case BluetoothSpp.MESSAGE_SPP_LOGGING:
